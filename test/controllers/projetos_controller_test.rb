...
class ProjetosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create projeto" do
    assert_difference('Projeto.count') do
      post projetos_url, params: { projeto: { codigo: @projeto.codigo, descricao: @projeto.descricao, nome: @projeto.nome, status: @projeto.status, tipo: @projeto.tipo } }
    end
  ...
  test "should update projeto" do
    patch projeto_url(@projeto), params: { projeto: { codigo: @projeto.codigo, descricao: @projeto.descricao, nome: @projeto.nome, status: @projeto.status, tipo: @projeto.tipo } }
