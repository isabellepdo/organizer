...
class TarefasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarefa" do
    assert_difference('Tarefa.count') do
      post tarefas_url, params: { tarefa: { codigo: @tarefa.codigo, nome: @tarefa.nome, tipo_de_projeto_id: @tarefa.tipo_de_projeto_id, valor: @tarefa.valor } }
    end
  ...
  test "should update tarefa" do
    patch tarefa_url(@tarefa), params: { tarefa: { codigo: @tarefa.codigo, nome: @tarefa.nome, tipo_de_projeto_id: @tarefa.tipo_de_projeto_id, valor: @tarefa.valor } }
