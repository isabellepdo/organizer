...
class AtividadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create atividade" do
    assert_difference('Atividade.count') do
      post atividades_url, params: { atividade: { nome: @atividade.nome, tipo_de_tarefa_id: @atividade.tipo_de_tarefa_id } }
    end
  ...
  test "should update atividade" do
    patch atividade_url(@atividade), params: { atividade: { nome: @atividade.nome, tipo_de_tarefa_id: @atividade.tipo_de_tarefa_id } }
